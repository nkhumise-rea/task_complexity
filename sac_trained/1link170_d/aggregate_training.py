...
#### scripting #########
###########################################
batch_1 = pd.read_csv('1link170_0.csv')
batch_2 = pd.read_csv('1link170_1.csv')
batch_3 = pd.read_csv('1link170_2.csv')
batch_4 = pd.read_csv('1link170_3.csv')
batch_5 = pd.read_csv('1link170_4.csv')
...
plt.plot(order_batch_1['Step'],run_batch_1[0],color="tomato",alpha=0.8, label="1-link [1.65]") #std_vs_mean
plt.plot(order_batch_2['Step'],run_batch_2[0],color="moccasin",alpha=0.8, label="1-link [1.65]") #std_vs_mean
plt.plot(order_batch_3['Step'],run_batch_3[0],color="mediumorchid",alpha=0.8, label="1-link [1.65]") #std_vs_mean
plt.plot(order_batch_4['Step'],run_batch_4[0],color="teal",alpha=0.8, label="1-link [1.65]") #std_vs_mean
plt.plot(order_batch_5['Step'],run_batch_5[0],color="chartreuse",alpha=0.8, label="1-link [1.65]") #std_vs_mean
plt.legend()
plt.show()