...
#### scripting #########
###########################################
batch_1 = pd.read_csv('2link_0.csv')
batch_2 = pd.read_csv('2link_1.csv')
batch_3 = pd.read_csv('2link_2.csv')
batch_4 = pd.read_csv('2link_3.csv')
batch_5 = pd.read_csv('2link_4.csv')
