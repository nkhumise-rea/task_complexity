...
arm_path = "/home/luca/Documents/PyBullet/single_arm/arm.urdf"
...
class SingleLink(gym.Env):
    ...
    ##insert datapoints *perform b4 reseting task*
    def datapoints(self,goal_startPos):
        self.theta_pos = goal_startPos[0]
        self.startPos = goal_startPos[1]
        return goal_startPos

    ##primary modules
    def step(self,action):
        self.action_scale = 15.25 
        self.step_id += 1
    ...
    def _reset_world(self):
        ...
        self.armID = p.loadURDF(arm_path, #"arm.urdf",
                    armStartPos,
                    armStartOrn,
                    useFixedBase = 1,)
