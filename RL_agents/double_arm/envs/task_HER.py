...
class DoubleLink(gym.Env):
    ...
    def step(self,action):
        ...
        #print('action: ', action)       
        #cont = 550 #15.25 #
        self.action_scale = np.array([195,95]) #np.array([25,15]) #based on statistics (determine.py) 
        self.step_id += 1
    ...
    def reset(self):
        ...
        self.radius = np.random.uniform(low = 0.35, high = (1.61) ) #low = 0.31 | high = l1+l2 - 3*0.05 + 0.01
