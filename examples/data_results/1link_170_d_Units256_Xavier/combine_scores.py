...
directory = Path('/home/rea/pic/examples/data_results/1link_170_d_Units256_Xavier')
extension = ".npy"

link_type = 1
reward_type = 'dense' #'sparse'
length = 170
sampling_type = 'Units256_Xavier' #'Units256' #'Units64' #'Bias' 'Uniform'  'Varian2' 'Xavier' 
