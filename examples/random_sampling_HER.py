...
from pic.sampler.sampler_HER import Sampler, make_env
...
def main():
    ...
    if args.env == "one_link": 
        sample_env = one_link_arm(head)
        print('one_link')
    else: 
        sample_env = two_link_arm(head)
        print('two_link')
    ...
    output_dir = os.path.join(
        args.root_dir,
        'dist_{}_layers{}_units{}_HER'.format(args.random_dist, args.n_layers, args.n_units) #sparse_rewards
        )
    os.makedirs(output_dir, exist_ok=True)
    # print('dist_{}_layers{}_units{}_HER'.format(args.random_dist, args.n_layers, args.n_units))
    ...
    np.save(os.path.join(output_dir, "{}{}.npy".format(args.env, args.count)), all_scores_per_param)
    # print(os.path.join(output_dir, "{}{}.npy".format(args.env, args.count)))

if __name__ == "__main__":
    main()


#testing_1:  python random_sampling_HER.py --env one_link --n_units 2 --n_samples 2 --n_episodes 2
#testing_2:  python random_sampling_HER.py --env two_link --n_units 2 --n_samples 2 --n_episodes 2
#local_execution_1:  python random_sampling_HER.py --env one_link --multiprocess 12 --n_samples 10000 --n_episodes 500
#local_execution_1:  python random_sampling_HER.py --env two_link --multiprocess 12 --n_samples 10000 --n_episodes 500