...
import sys
sys.path.insert(0, "..")
from task_obstacle import DoubleLink as two_link_arm
...
if __name__ == '__main__':  
    ...
    for sample in range(num_samples):
        ...
        # print('duration: ', (end_time_in-start_time)/60 )
    ...
    # print('samples_df: \n',samples_df)
    # print('duration: ', (end_time_out-start_time)/60 )
    # xxx
